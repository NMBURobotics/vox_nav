...
#include "quadrotor_control_planners_benchmark.hpp"
...
ompl::base::OptimizationObjectivePtr QuadrotorControlPlannersBenchMarking::getOptimizationObjective()
{
...
std::map<int, ompl::control::PathControl> QuadrotorControlPlannersBenchMarking::doBenchMarking()
{
  ompl::base::ScopedState<ompl::base::RealVectorStateSpace> random_start(state_space_), random_goal(state_space_);
  ...
  for (int i = 0; i < epochs_; i++)
  {
    ...
    random_start->values[6] = 0;
    random_start->values[7] = 0;
    random_start->values[8] = 0;
    random_start->values[9] = 0;
    random_start->values[10] = 0;
    random_start->values[11] = 0;
    random_start->values[12] = 0;
    random_start->values[13] = 0;
    random_start->values[14] = 0;
    ...
    random_goal->values[6] = 0;
    random_goal->values[7] = 0;
    random_goal->values[8] = 0;
    random_goal->values[9] = 0;
    random_goal->values[10] = 0;
    random_goal->values[11] = 0;
    random_goal->values[12] = 0;
    random_goal->values[13] = 0;
    random_goal->values[14] = 0;
