...
#include "vox_nav_planning/plugins/dubins_3d_planner.hpp"
...
namespace vox_nav_planning
{
  ...
  Dubins3DPlanner::Dubins3DPlanner()
  {
  }
  ...
  void Dubins3DPlanner::initialize(
    rclcpp::Node * parent,
    const std::string & plugin_name)
  {
    ...
    horizontal_dubins_bounds_ = std::make_shared<ompl::base::RealVectorBounds>(2);
    vertical_dubins_bounds_ = std::make_shared<ompl::base::RealVectorBounds>(2);
    ...
    if (!is_enabled_) {
      RCLCPP_WARN(logger_, "Dubins3DPlanner plugin is disabled.");
    }
  ...
  std::vector<geometry_msgs::msg::PoseStamped> Dubins3DPlanner::createPlan(
    ...
    const geometry_msgs::msg::PoseStamped & goal)
  {
    if (!is_enabled_) {
      RCLCPP_WARN(
        logger_,
        "Dubins3DPlanner plugin is disabled. Not performing anything returning an empty path"
      );
    ...
    ompl::base::ScopedState<ompl::base::Dubins3DStateSpace>
  ...
  bool Dubins3DPlanner::isStateValid(const ompl::base::State * state)
  {

    const auto * cstate = state->as<ompl::base::Dubins3DStateSpace::StateType>();
    ...
    fcl::Vec3f translation(dubins_HOR->getX(), dubins_HOR->getY(), dubins_VER->getX());
  ...
  /*ompl::base::ValidStateSamplerPtr Dubins3DPlanner::allocValidStateSampler(
  ...
  ompl::base::OptimizationObjectivePtr Dubins3DPlanner::getOptimizationObjective()
  {
  ...
  std::vector<geometry_msgs::msg::PoseStamped> Dubins3DPlanner::getOverlayedStartandGoal()
  {
...
PLUGINLIB_EXPORT_CLASS(vox_nav_planning::Dubins3DPlanner, vox_nav_planning::PlannerCore)
