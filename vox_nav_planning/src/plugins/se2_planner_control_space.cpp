...
#include "vox_nav_planning/plugins/se2_planner_control_space.hpp"
...
PLUGINLIB_EXPORT_CLASS(vox_nav_planning::SE2PlannerControlSpace, vox_nav_planning::PlannerCore)
