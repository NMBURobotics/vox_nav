...
def generate_launch_description():
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(grid_map_demos_dir, 'rviz',
                                   'archived_vox_nav_grid_map.rviz'),
        description='Full path to the RVIZ config file to use')

    # Declare node actions
    tutorial_demo_node = Node(package='archived_vox_nav_grid_map',
                              executable='archived_vox_nav_grid_map_node',
                              name='archived_vox_nav_grid_map_node',
                              output='screen',
