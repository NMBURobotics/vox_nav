...
def generate_launch_description():
    ...
    configuration_basename = LaunchConfiguration('configuration_basename', default='botanbot_lds_3d.lua')

    resolution = LaunchConfiguration('resolution', default='0.05')
    publish_period_sec = LaunchConfiguration('publish_period_sec', default='1.0')

    rviz_config_dir = os.path.join(get_package_share_directory('botanbot_cartographer'), 'rviz', 'cartographer.rviz')
