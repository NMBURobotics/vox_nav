...
namespace vox_nav_control
{
  namespace mpc_controller_acado
  {
    ...
    private:
      Eigen::Map<Eigen::Matrix<float, kRefSize, kSamples,
        Eigen::ColMajor>> acado_reference_states_{0};
      Eigen::Map<Eigen::Matrix<float, kEndRefSize, 1,
        Eigen::ColMajor>> acado_reference_end_state_{0};
      Eigen::Map<Eigen::Matrix<float, kStateSize, 1, Eigen::ColMajor>> acado_initial_state_{0};
      Eigen::Map<Eigen::Matrix<float, kStateSize, kSamples + 1, Eigen::ColMajor>> acado_states_{0};
      Eigen::Map<Eigen::Matrix<float, kInputSize, kSamples, Eigen::ColMajor>> acado_inputs_{0};
      Eigen::Map<Eigen::Matrix<float, kOdSize, kSamples + 1,
        Eigen::ColMajor>> acado_online_data_{0};
      Eigen::Map<Eigen::Matrix<float, kRefSize, kRefSize * kSamples>> acado_W_{0};
      Eigen::Map<Eigen::Matrix<float, kEndRefSize, kEndRefSize>> acado_W_end_{0};
      Eigen::Map<Eigen::Matrix<float, 3, kSamples, Eigen::ColMajor>> acado_lower_bounds_{0};
      Eigen::Map<Eigen::Matrix<float, 3, kSamples, Eigen::ColMajor>> acado_upper_bounds_{0};
