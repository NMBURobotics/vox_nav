...
#ifndef VOX_NAV_CONTROL__MPC_CONTROLLER__MPC_CONTROLLER_ACADO_SUPERVOXEL_ROS_HPP_
#define VOX_NAV_CONTROL__MPC_CONTROLLER__MPC_CONTROLLER_ACADO_SUPERVOXEL_ROS_HPP_
 ...
 *
 */
    class MPCControllerAcadoSupervoxelROS : public vox_nav_control::ControllerCore
    {
    public:
      /**
       * @brief Construct a new MPCControllerAcadoSupervoxelROS object
       *
       */
      MPCControllerAcadoSupervoxelROS();

      /**
       * @brief Destroy the MPCControllerAcadoSupervoxelROS object
       *
       */
      ~MPCControllerAcadoSupervoxelROS();
    ...
    private:
      ...
      pcl::PointCloud<pcl::PointXYZRGBA>::Ptr map_cloud_;
...
#endif  // VOX_NAV_CONTROL__MPC_CONTROLLER__MPC_CONTROLLER_ACADO_SUPERVOXEL_ROS_HPP_
