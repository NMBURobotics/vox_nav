 ...
 * 
 *  Matrix containing 16 reference/measurement vectors of size 6 for first 16 nodes.
 */
real_t y[ 96 ];
...
/** Matrix of size: 96 x 6 (row major format) */
real_t W[ 576 ];
...
/** Matrix of size: 64 x 6 (row major format) */
real_t Q2[ 384 ];
