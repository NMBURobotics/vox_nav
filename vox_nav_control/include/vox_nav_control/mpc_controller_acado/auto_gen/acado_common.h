...
{
int dummy;
/** Matrix of size: 6 x 4 (row major format)
 * 
 ...
 * 
 *  Matrix containing 5 reference/measurement vectors of size 4 for first 5 nodes.
 */
real_t y[ 20 ];
...
/** Matrix of size: 5 x 10 (row major format) */
real_t A[ 50 ];
