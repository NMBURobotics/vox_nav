...
/** Matrix of size: 17 x 48 (row major format)
 * 
 ...
 * 
 *  Matrix containing 16 reference/measurement vectors of size 7 for first 16 nodes.
 */
real_t y[ 112 ];
...
/** Matrix of size: 112 x 7 (row major format) */
real_t W[ 784 ];
...
real_t objAuxVar[ 240 ];

/** Row vector of size: 54 */
real_t objValueIn[ 54 ];
...
/** Matrix of size: 64 x 7 (row major format) */
real_t Q2[ 448 ];

/** Matrix of size: 32 x 2 (row major format) */
real_t R1[ 64 ];

/** Matrix of size: 32 x 7 (row major format) */
real_t R2[ 224 ];
...
real_t conAuxVar[ 208 ];

/** Row vector of size: 54 */
real_t conValueIn[ 54 ];

/** Row vector of size: 112 */
real_t conValueOut[ 112 ];

/** Column vector of size: 256 */
real_t evH[ 256 ];

/** Matrix of size: 256 x 4 (row major format) */
real_t evHx[ 1024 ];

/** Matrix of size: 256 x 2 (row major format) */
real_t evHu[ 512 ];
...
/** Matrix of size: 544 x 2 (row major format) */
real_t E[ 1088 ];
...
/** Column vector of size: 256 */
real_t pacA01Dx0[ 256 ];

/** Matrix of size: 32 x 32 (row major format) */
real_t H[ 1024 ];

/** Matrix of size: 256 x 32 (row major format) */
real_t A[ 8192 ];
 ...
 *
 *  \param rk_eta Working array of size 54 to pass the input values and return the results.
