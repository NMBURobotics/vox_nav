 ...
 * 
 *  Matrix containing 20 reference/measurement vectors of size 6 for first 20 nodes.
 */
real_t y[ 120 ];
...
/** Matrix of size: 80 x 6 (row major format) */
real_t Q2[ 480 ];
...
/** Matrix of size: 840 x 2 (row major format) */
real_t E[ 1680 ];
