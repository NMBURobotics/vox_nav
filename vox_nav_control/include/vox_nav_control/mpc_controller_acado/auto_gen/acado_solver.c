...
a[5] = (pow((xd[1]-od[5]),2));
a[6] = (sqrt((a[4]+a[5])));
a[7] = (exp(((real_t)(1.0000000000000000e+01)*(a[6]-od[6]))));
a[8] = (pow((xd[0]-od[8]),2));
a[9] = (pow((xd[1]-od[9]),2));
a[10] = (sqrt((a[8]+a[9])));
a[11] = (exp(((real_t)(1.0000000000000000e+01)*(a[10]-od[10]))));
a[12] = (pow((xd[0]-od[12]),2));
a[13] = (pow((xd[1]-od[13]),2));
a[14] = (sqrt((a[12]+a[13])));
a[15] = (exp(((real_t)(1.0000000000000000e+01)*(a[14]-od[14]))));
...
a[27] = (a[24]*a[26]);
a[28] = (exp(((real_t)(1.0000000000000000e+01)*(a[6]-od[6]))));
...
a[35] = (a[32]*a[34]);
a[36] = (exp(((real_t)(1.0000000000000000e+01)*(a[10]-od[10]))));
...
a[43] = (a[40]*a[42]);
a[44] = (exp(((real_t)(1.0000000000000000e+01)*(a[14]-od[14]))));
...
/* Compute outputs: */
out[0] = (((a[0]/a[1])+(a[2]/a[3]))-(real_t)(9.0000000000000002e-01));
out[1] = (((a[4]/a[5])+(a[6]/a[7]))-(real_t)(9.0000000000000002e-01));
out[2] = (((a[8]/a[9])+(a[10]/a[11]))-(real_t)(9.0000000000000002e-01));
out[3] = (((a[12]/a[13])+(a[14]/a[15]))-(real_t)(9.0000000000000002e-01));
out[4] = a[18];
out[5] = a[21];
out[6] = a[22];
out[7] = a[23];
