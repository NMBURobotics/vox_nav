...
state[30] = acadoVariables.od[lRun1 * 16];
state[31] = acadoVariables.od[lRun1 * 16 + 1];
state[32] = acadoVariables.od[lRun1 * 16 + 2];
state[33] = acadoVariables.od[lRun1 * 16 + 3];
state[34] = acadoVariables.od[lRun1 * 16 + 4];
state[35] = acadoVariables.od[lRun1 * 16 + 5];
state[36] = acadoVariables.od[lRun1 * 16 + 6];
state[37] = acadoVariables.od[lRun1 * 16 + 7];
state[38] = acadoVariables.od[lRun1 * 16 + 8];
state[39] = acadoVariables.od[lRun1 * 16 + 9];
state[40] = acadoVariables.od[lRun1 * 16 + 10];
state[41] = acadoVariables.od[lRun1 * 16 + 11];
state[42] = acadoVariables.od[lRun1 * 16 + 12];
state[43] = acadoVariables.od[lRun1 * 16 + 13];
state[44] = acadoVariables.od[lRun1 * 16 + 14];
state[45] = acadoVariables.od[lRun1 * 16 + 15];
...
a[20] = ((real_t)(4.0000000000000000e+00)*(pow((((a[0]/a[1])+(a[2]/a[3]))-(real_t)(1.0000000000000000e+00)),3)));
a[21] = ((real_t)(2.0000000000000000e+00)*(xd[0]-od[0]));
a[22] = ((real_t)(1.0000000000000000e+00)/a[1]);
a[23] = ((real_t)(1.0000000000000000e+00)/(pow((((a[0]/a[1])+(a[2]/a[3]))-(real_t)(1.0000000000000000e+00)),4)));
a[24] = (a[23]*a[23]);
a[25] = (exp(((real_t)(1.0000000000000000e+00)/(pow((((a[0]/a[1])+(a[2]/a[3]))-(real_t)(1.0000000000000000e+00)),4)))));
a[26] = (((real_t)(0.0000000000000000e+00)-((a[20]*(a[21]*a[22]))*a[24]))*a[25]);
a[27] = ((real_t)(4.0000000000000000e+00)*(pow((((a[5]/a[6])+(a[7]/a[8]))-(real_t)(1.0000000000000000e+00)),3)));
a[28] = ((real_t)(2.0000000000000000e+00)*(xd[0]-od[4]));
a[29] = ((real_t)(1.0000000000000000e+00)/a[6]);
a[30] = ((real_t)(1.0000000000000000e+00)/(pow((((a[5]/a[6])+(a[7]/a[8]))-(real_t)(1.0000000000000000e+00)),4)));
a[31] = (a[30]*a[30]);
a[32] = (exp(((real_t)(1.0000000000000000e+00)/(pow((((a[5]/a[6])+(a[7]/a[8]))-(real_t)(1.0000000000000000e+00)),4)))));
a[33] = (((real_t)(0.0000000000000000e+00)-((a[27]*(a[28]*a[29]))*a[31]))*a[32]);
a[34] = ((real_t)(4.0000000000000000e+00)*(pow((((a[10]/a[11])+(a[12]/a[13]))-(real_t)(1.0000000000000000e+00)),3)));
a[35] = ((real_t)(2.0000000000000000e+00)*(xd[0]-od[8]));
a[36] = ((real_t)(1.0000000000000000e+00)/a[11]);
a[37] = ((real_t)(1.0000000000000000e+00)/(pow((((a[10]/a[11])+(a[12]/a[13]))-(real_t)(1.0000000000000000e+00)),4)));
a[38] = (a[37]*a[37]);
a[39] = (exp(((real_t)(1.0000000000000000e+00)/(pow((((a[10]/a[11])+(a[12]/a[13]))-(real_t)(1.0000000000000000e+00)),4)))));
a[40] = (((real_t)(0.0000000000000000e+00)-((a[34]*(a[35]*a[36]))*a[38]))*a[39]);
a[41] = ((real_t)(4.0000000000000000e+00)*(pow((((a[15]/a[16])+(a[17]/a[18]))-(real_t)(1.0000000000000000e+00)),3)));
a[42] = ((real_t)(2.0000000000000000e+00)*(xd[0]-od[12]));
a[43] = ((real_t)(1.0000000000000000e+00)/a[16]);
a[44] = ((real_t)(1.0000000000000000e+00)/(pow((((a[15]/a[16])+(a[17]/a[18]))-(real_t)(1.0000000000000000e+00)),4)));
a[45] = (a[44]*a[44]);
a[46] = (exp(((real_t)(1.0000000000000000e+00)/(pow((((a[15]/a[16])+(a[17]/a[18]))-(real_t)(1.0000000000000000e+00)),4)))));
a[47] = (((real_t)(0.0000000000000000e+00)-((a[41]*(a[42]*a[43]))*a[45]))*a[46]);
a[48] = ((real_t)(2.0000000000000000e+00)*(xd[1]-od[1]));
a[49] = ((real_t)(1.0000000000000000e+00)/a[3]);
a[50] = (((real_t)(0.0000000000000000e+00)-((a[20]*(a[48]*a[49]))*a[24]))*a[25]);
a[51] = ((real_t)(2.0000000000000000e+00)*(xd[1]-od[5]));
a[52] = ((real_t)(1.0000000000000000e+00)/a[8]);
a[53] = (((real_t)(0.0000000000000000e+00)-((a[27]*(a[51]*a[52]))*a[31]))*a[32]);
a[54] = ((real_t)(2.0000000000000000e+00)*(xd[1]-od[9]));
a[55] = ((real_t)(1.0000000000000000e+00)/a[13]);
a[56] = (((real_t)(0.0000000000000000e+00)-((a[34]*(a[54]*a[55]))*a[38]))*a[39]);
a[57] = ((real_t)(2.0000000000000000e+00)*(xd[1]-od[13]));
a[58] = ((real_t)(1.0000000000000000e+00)/a[18]);
a[59] = (((real_t)(0.0000000000000000e+00)-((a[41]*(a[57]*a[58]))*a[45]))*a[46]);
...
out[31] = (((a[26]+a[33])+a[40])+a[47]);
out[32] = (((a[50]+a[53])+a[56])+a[59]);
...
acadoWorkspace.objValueIn[6] = acadoVariables.od[runObj * 16];
acadoWorkspace.objValueIn[7] = acadoVariables.od[runObj * 16 + 1];
acadoWorkspace.objValueIn[8] = acadoVariables.od[runObj * 16 + 2];
acadoWorkspace.objValueIn[9] = acadoVariables.od[runObj * 16 + 3];
acadoWorkspace.objValueIn[10] = acadoVariables.od[runObj * 16 + 4];
acadoWorkspace.objValueIn[11] = acadoVariables.od[runObj * 16 + 5];
acadoWorkspace.objValueIn[12] = acadoVariables.od[runObj * 16 + 6];
acadoWorkspace.objValueIn[13] = acadoVariables.od[runObj * 16 + 7];
acadoWorkspace.objValueIn[14] = acadoVariables.od[runObj * 16 + 8];
acadoWorkspace.objValueIn[15] = acadoVariables.od[runObj * 16 + 9];
acadoWorkspace.objValueIn[16] = acadoVariables.od[runObj * 16 + 10];
acadoWorkspace.objValueIn[17] = acadoVariables.od[runObj * 16 + 11];
acadoWorkspace.objValueIn[18] = acadoVariables.od[runObj * 16 + 12];
acadoWorkspace.objValueIn[19] = acadoVariables.od[runObj * 16 + 13];
acadoWorkspace.objValueIn[20] = acadoVariables.od[runObj * 16 + 14];
acadoWorkspace.objValueIn[21] = acadoVariables.od[runObj * 16 + 15];
...
acadoWorkspace.objValueIn[4] = acadoVariables.od[256];
acadoWorkspace.objValueIn[5] = acadoVariables.od[257];
acadoWorkspace.objValueIn[6] = acadoVariables.od[258];
acadoWorkspace.objValueIn[7] = acadoVariables.od[259];
acadoWorkspace.objValueIn[8] = acadoVariables.od[260];
acadoWorkspace.objValueIn[9] = acadoVariables.od[261];
acadoWorkspace.objValueIn[10] = acadoVariables.od[262];
acadoWorkspace.objValueIn[11] = acadoVariables.od[263];
acadoWorkspace.objValueIn[12] = acadoVariables.od[264];
acadoWorkspace.objValueIn[13] = acadoVariables.od[265];
acadoWorkspace.objValueIn[14] = acadoVariables.od[266];
acadoWorkspace.objValueIn[15] = acadoVariables.od[267];
acadoWorkspace.objValueIn[16] = acadoVariables.od[268];
acadoWorkspace.objValueIn[17] = acadoVariables.od[269];
acadoWorkspace.objValueIn[18] = acadoVariables.od[270];
acadoWorkspace.objValueIn[19] = acadoVariables.od[271];
...
const real_t* xd = in;
const real_t* od = in + 6;
/* Vector of auxiliary variables; number of elements: 56. */
...
a[18] = (a[16]*a[17]);
a[19] = ((real_t)(2.0000000000000000e+00)*(xd[1]-od[1]));
a[20] = ((real_t)(1.0000000000000000e+00)/a[3]);
a[21] = (a[19]*a[20]);
a[22] = (real_t)(0.0000000000000000e+00);
a[23] = (real_t)(0.0000000000000000e+00);
a[24] = ((real_t)(2.0000000000000000e+00)*(xd[0]-od[4]));
a[25] = ((real_t)(1.0000000000000000e+00)/a[5]);
a[26] = (a[24]*a[25]);
a[27] = ((real_t)(2.0000000000000000e+00)*(xd[1]-od[5]));
a[28] = ((real_t)(1.0000000000000000e+00)/a[7]);
a[29] = (a[27]*a[28]);
a[30] = (real_t)(0.0000000000000000e+00);
a[31] = (real_t)(0.0000000000000000e+00);
a[32] = ((real_t)(2.0000000000000000e+00)*(xd[0]-od[8]));
a[33] = ((real_t)(1.0000000000000000e+00)/a[9]);
a[34] = (a[32]*a[33]);
a[35] = ((real_t)(2.0000000000000000e+00)*(xd[1]-od[9]));
a[36] = ((real_t)(1.0000000000000000e+00)/a[11]);
a[37] = (a[35]*a[36]);
a[38] = (real_t)(0.0000000000000000e+00);
a[39] = (real_t)(0.0000000000000000e+00);
a[40] = ((real_t)(2.0000000000000000e+00)*(xd[0]-od[12]));
a[41] = ((real_t)(1.0000000000000000e+00)/a[13]);
a[42] = (a[40]*a[41]);
a[43] = ((real_t)(2.0000000000000000e+00)*(xd[1]-od[13]));
a[44] = ((real_t)(1.0000000000000000e+00)/a[15]);
a[45] = (a[43]*a[44]);
...
/* Compute outputs: */
out[0] = (((a[0]/a[1])+(a[2]/a[3]))-(real_t)(1.8000000000000000e+00));
out[1] = (((a[4]/a[5])+(a[6]/a[7]))-(real_t)(1.8000000000000000e+00));
out[2] = (((a[8]/a[9])+(a[10]/a[11]))-(real_t)(1.8000000000000000e+00));
out[3] = (((a[12]/a[13])+(a[14]/a[15]))-(real_t)(1.8000000000000000e+00));
out[4] = a[18];
out[5] = a[21];
out[6] = a[22];
out[7] = a[23];
...
acadoWorkspace.conValueIn[6] = acadoVariables.od[lRun1 * 16];
acadoWorkspace.conValueIn[7] = acadoVariables.od[lRun1 * 16 + 1];
acadoWorkspace.conValueIn[8] = acadoVariables.od[lRun1 * 16 + 2];
acadoWorkspace.conValueIn[9] = acadoVariables.od[lRun1 * 16 + 3];
acadoWorkspace.conValueIn[10] = acadoVariables.od[lRun1 * 16 + 4];
acadoWorkspace.conValueIn[11] = acadoVariables.od[lRun1 * 16 + 5];
acadoWorkspace.conValueIn[12] = acadoVariables.od[lRun1 * 16 + 6];
acadoWorkspace.conValueIn[13] = acadoVariables.od[lRun1 * 16 + 7];
acadoWorkspace.conValueIn[14] = acadoVariables.od[lRun1 * 16 + 8];
acadoWorkspace.conValueIn[15] = acadoVariables.od[lRun1 * 16 + 9];
acadoWorkspace.conValueIn[16] = acadoVariables.od[lRun1 * 16 + 10];
acadoWorkspace.conValueIn[17] = acadoVariables.od[lRun1 * 16 + 11];
acadoWorkspace.conValueIn[18] = acadoVariables.od[lRun1 * 16 + 12];
acadoWorkspace.conValueIn[19] = acadoVariables.od[lRun1 * 16 + 13];
acadoWorkspace.conValueIn[20] = acadoVariables.od[lRun1 * 16 + 14];
acadoWorkspace.conValueIn[21] = acadoVariables.od[lRun1 * 16 + 15];
...
state[30] = acadoVariables.od[index * 16];
state[31] = acadoVariables.od[index * 16 + 1];
state[32] = acadoVariables.od[index * 16 + 2];
state[33] = acadoVariables.od[index * 16 + 3];
state[34] = acadoVariables.od[index * 16 + 4];
state[35] = acadoVariables.od[index * 16 + 5];
state[36] = acadoVariables.od[index * 16 + 6];
state[37] = acadoVariables.od[index * 16 + 7];
state[38] = acadoVariables.od[index * 16 + 8];
state[39] = acadoVariables.od[index * 16 + 9];
state[40] = acadoVariables.od[index * 16 + 10];
state[41] = acadoVariables.od[index * 16 + 11];
state[42] = acadoVariables.od[index * 16 + 12];
state[43] = acadoVariables.od[index * 16 + 13];
state[44] = acadoVariables.od[index * 16 + 14];
state[45] = acadoVariables.od[index * 16 + 15];
...
state[30] = acadoVariables.od[256];
state[31] = acadoVariables.od[257];
state[32] = acadoVariables.od[258];
state[33] = acadoVariables.od[259];
state[34] = acadoVariables.od[260];
state[35] = acadoVariables.od[261];
state[36] = acadoVariables.od[262];
state[37] = acadoVariables.od[263];
state[38] = acadoVariables.od[264];
state[39] = acadoVariables.od[265];
state[40] = acadoVariables.od[266];
state[41] = acadoVariables.od[267];
state[42] = acadoVariables.od[268];
state[43] = acadoVariables.od[269];
state[44] = acadoVariables.od[270];
state[45] = acadoVariables.od[271];
...
acadoWorkspace.objValueIn[6] = acadoVariables.od[lRun1 * 16];
acadoWorkspace.objValueIn[7] = acadoVariables.od[lRun1 * 16 + 1];
acadoWorkspace.objValueIn[8] = acadoVariables.od[lRun1 * 16 + 2];
acadoWorkspace.objValueIn[9] = acadoVariables.od[lRun1 * 16 + 3];
acadoWorkspace.objValueIn[10] = acadoVariables.od[lRun1 * 16 + 4];
acadoWorkspace.objValueIn[11] = acadoVariables.od[lRun1 * 16 + 5];
acadoWorkspace.objValueIn[12] = acadoVariables.od[lRun1 * 16 + 6];
acadoWorkspace.objValueIn[13] = acadoVariables.od[lRun1 * 16 + 7];
acadoWorkspace.objValueIn[14] = acadoVariables.od[lRun1 * 16 + 8];
acadoWorkspace.objValueIn[15] = acadoVariables.od[lRun1 * 16 + 9];
acadoWorkspace.objValueIn[16] = acadoVariables.od[lRun1 * 16 + 10];
acadoWorkspace.objValueIn[17] = acadoVariables.od[lRun1 * 16 + 11];
acadoWorkspace.objValueIn[18] = acadoVariables.od[lRun1 * 16 + 12];
acadoWorkspace.objValueIn[19] = acadoVariables.od[lRun1 * 16 + 13];
acadoWorkspace.objValueIn[20] = acadoVariables.od[lRun1 * 16 + 14];
acadoWorkspace.objValueIn[21] = acadoVariables.od[lRun1 * 16 + 15];
