...
a[0] = (pow((xd[0]-od[0]),2));
a[1] = (pow(((od[2]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[2] = (pow((xd[1]-od[1]),2));
a[3] = (pow(((od[3]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[4] = (exp(((real_t)(1.0000000000000000e+00)/((a[0]/a[1])+(a[2]/a[3])))));
a[5] = (pow((xd[0]-od[4]),2));
a[6] = (pow(((od[6]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[7] = (pow((xd[1]-od[5]),2));
a[8] = (pow(((od[7]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[9] = (exp(((real_t)(1.0000000000000000e+00)/((a[5]/a[6])+(a[7]/a[8])))));
a[10] = (pow((xd[0]-od[8]),2));
a[11] = (pow(((od[10]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[12] = (pow((xd[1]-od[9]),2));
a[13] = (pow(((od[11]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[14] = (exp(((real_t)(1.0000000000000000e+00)/((a[10]/a[11])+(a[12]/a[13])))));
a[15] = (pow((xd[0]-od[12]),2));
a[16] = (pow(((od[14]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[17] = (pow((xd[1]-od[13]),2));
a[18] = (pow(((od[15]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[19] = (exp(((real_t)(1.0000000000000000e+00)/((a[15]/a[16])+(a[17]/a[18])))));
a[20] = (pow((xd[0]-od[16]),2));
a[21] = (pow(((od[18]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[22] = (pow((xd[1]-od[17]),2));
a[23] = (pow(((od[19]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[24] = (exp(((real_t)(1.0000000000000000e+00)/((a[20]/a[21])+(a[22]/a[23])))));
a[25] = (pow((xd[0]-od[20]),2));
a[26] = (pow(((od[22]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
a[27] = (pow((xd[1]-od[21]),2));
a[28] = (pow(((od[23]/(real_t)(2.0000000000000000e+00))+(real_t)(9.3999999999999995e-01)),2));
