...
#include <vox_nav_control/mpc_controller_acado/mpc_controller_acado_supervoxel_ros.hpp>
...
namespace vox_nav_control
{
  ...
  namespace mpc_controller_acado_supervoxel
  {
    MPCControllerAcadoSupervoxelROS::MPCControllerAcadoSupervoxelROS()
    {
    }
    ...
    void MPCControllerAcadoSupervoxelROS::initialize(
      rclcpp::Node * parent,
      const std::string & plugin_name)
    {
      ...
      obstacle_tracks_sub_ = parent->create_subscription<vox_nav_msgs::msg::ObjectArray>(
        ...
        std::bind(
          &MPCControllerAcadoSupervoxelROS::obstacleTracksCallback, this,
          std::placeholders::_1));
      ...
      map_cloud_subscriber_ = parent->create_subscription<sensor_msgs::msg::PointCloud2>(
        "traversable_pointcloud",
        rclcpp::SensorDataQoS(),
        std::bind(
          &MPCControllerAcadoSupervoxelROS::mapCloudCallback, this, std::placeholders::_1));

      map_cloud_pub_ = parent->create_publisher<sensor_msgs::msg::PointCloud2>(
        "vox_nav/control/supervoxel_pointcloud", rclcpp::SystemDefaultsQoS());

      map_cloud_ = pcl::make_shared<pcl::PointCloud<pcl::PointXYZRGBA>>();

      timer_ = parent->create_wall_timer(
        std::chrono::milliseconds(static_cast<int>(1000 / 0.5)),
        std::bind(&MPCControllerAcadoSupervoxelROS::timerCallback, this));

      super_voxel_adjacency_marker_pub_ =
        parent->create_publisher<visualization_msgs::msg::MarkerArray>(
        "vox_nav/control/supervoxel_adjacency_markers", rclcpp::SystemDefaultsQoS());
    }

    void MPCControllerAcadoSupervoxelROS::timerCallback()
    {
      auto super = vox_nav_utilities::supervoxelizeCloud<pcl::PointXYZRGBA>(
        map_cloud_,
        /*supervoxel_disable_transform_*/ false,
        /*supervoxel_resolution_*/ 0.4,
        /*supervoxel_seed_resolution_*/ 2.0,
        /*supervoxel_color_importance_*/ 0.0,
        /*supervoxel_spatial_importance_*/ 1.0,
        /*supervoxel_normal_importance_*/ 1.0);
      ...
      RCLCPP_INFO(parent_->get_logger(), "Extracting supervoxels!");
      super.extract(supervoxel_clusters);
      RCLCPP_INFO(parent_->get_logger(), "Found %d supervoxels", supervoxel_clusters.size());
      super.refineSupervoxels(3, supervoxel_clusters);

      std::multimap<std::uint32_t, std::uint32_t> supervoxel_adjacency;
      super.getSupervoxelAdjacency(supervoxel_adjacency);

      auto pt = super.getLabeledVoxelCloud();
      if (pt) {
        RCLCPP_INFO(
          parent_->get_logger(), "Found %d points",
          super.getLabeledVoxelCloud()->points.size());

        auto cloud = std::make_shared<sensor_msgs::msg::PointCloud2>();
        pcl::toROSMsg(*super.getLabeledVoxelCloud(), *cloud);
        cloud->header.frame_id = "map";
        cloud->header.stamp = parent_->now();
        map_cloud_pub_->publish(*cloud);
        ...
        vox_nav_utilities::fillSuperVoxelMarkersfromAdjacency(
          supervoxel_clusters, supervoxel_adjacency, header, marker_array);
        super_voxel_adjacency_marker_pub_->publish(marker_array);

      }
    }

    void MPCControllerAcadoSupervoxelROS::mapCloudCallback(
      const sensor_msgs::msg::PointCloud2::ConstSharedPtr cloud)
    {
      std::call_once(
        get_map_cloud_once_, [&]()
        {
          ...
          RCLCPP_INFO(
            parent_->get_logger(), "Map Cloud with %d points...",
            map_cloud_->points.size());
        });
    }

    geometry_msgs::msg::Twist MPCControllerAcadoSupervoxelROS::computeVelocityCommands(
    ...
    geometry_msgs::msg::Twist MPCControllerAcadoSupervoxelROS::computeHeadingCorrectionCommands(
      geometry_msgs::msg::PoseStamped curr_robot_pose)
    {
    ...
    void MPCControllerAcadoSupervoxelROS::setPlan(const nav_msgs::msg::Path & path)
    {
      reference_traj_ = path;
    }

    void MPCControllerAcadoSupervoxelROS::obstacleTracksCallback(
    ...
    std::vector<vox_nav_control::common::Ellipsoid> MPCControllerAcadoSupervoxelROS::
    trackMsg2Ellipsoids(
    ...
    void MPCControllerAcadoSupervoxelROS::initAcadoStuff()
    {
    ...
    void MPCControllerAcadoSupervoxelROS::initAcadoWeights()
    {
    ...
    void MPCControllerAcadoSupervoxelROS::setRefrenceStates(
    ...
    void MPCControllerAcadoSupervoxelROS::updateCurrentStates(
      vox_nav_control::common::States curr_states)
    {
    ...
    std::vector<vox_nav_control::common::ControlInput> MPCControllerAcadoSupervoxelROS::
    getPredictedControlsFromAcado()
    {
      std::vector<vox_nav_control::common::ControlInput> computed_controls;
    ...
    std::vector<vox_nav_control::common::States> MPCControllerAcadoSupervoxelROS::
    getPredictedStatesFromAcado()
    {
      std::vector<vox_nav_control::common::States> computed_states;
  ...
  PLUGINLIB_EXPORT_CLASS(
    mpc_controller_acado_supervoxel::MPCControllerAcadoSupervoxelROS,
