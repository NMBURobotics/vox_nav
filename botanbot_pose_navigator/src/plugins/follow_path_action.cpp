...
#include "botanbot_pose_navigator/plugins/follow_path_action.hpp"
...
: BtActionNode<botanbot_msgs::action::FollowPath>(xml_tag_name, action_name, conf)
{
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<botanbot_pose_navigator::FollowPathAction>(
        name, "follow_path", config);
    };

  factory.registerBuilder<botanbot_pose_navigator::FollowPathAction>(
    "FollowPath", builder);
}
