...
#ifndef VOX_NAV_NAVIGATORS__NAVIGATE_THROUGH_POSES_GPS_ACTION_SERVER_NODE_HPP_
#define VOX_NAV_NAVIGATORS__NAVIGATE_THROUGH_POSES_GPS_ACTION_SERVER_NODE_HPP_
...
namespace vox_nav_navigators
{
  ...
  class NavigateThroughGPSPosesActionServer : public rclcpp::Node
  {
  public:
    NavigateThroughGPSPosesActionServer();
    ~NavigateThroughGPSPosesActionServer();

  protected:
    // A couple declarations for convenince
    using ActionServer = vox_nav_msgs::action::NavigateThroughGPSPoses;
    ...
    void navigate_through_gps_poses(const std::shared_ptr<GoalHandle> goal_handle);
...
#endif  // VOX_NAV_NAVIGATORS__NAVIGATE_THROUGH_POSES_GPS_ACTION_SERVER_NODE_HPP_
