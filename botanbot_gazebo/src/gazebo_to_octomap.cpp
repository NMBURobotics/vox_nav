  ...
  sdf::ElementPtr _sdf)
{
  ...
  RCLCPP_INFO(node_->get_logger(), "Contrcting an instance of gazebo_world_to_octomap_rclcpp_node");
  ...
  auto service_callback = [this](
    const std::shared_ptr<botanbot_msgs::srv::GetOctomap::Request> req,
    std::shared_ptr<botanbot_msgs::srv::GetOctomap::Response> res)
    {
  ...
  srv_ = node_->create_service<botanbot_msgs::srv::GetOctomap>(service_name, service_callback);
}
...
void OctomapFromGazeboWorld::CreateOctomap(
  const botanbot_msgs::srv::GetOctomap::Request & msg)
{
