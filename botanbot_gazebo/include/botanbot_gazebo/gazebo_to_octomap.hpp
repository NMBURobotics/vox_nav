...
#include <botanbot_msgs/srv/get_octomap.hpp>
...
protected:
  ...
  */
  void CreateOctomap(const botanbot_msgs::srv::GetOctomap::Request & msg);

private:
  physics::WorldPtr world_;
  gazebo_ros::Node::SharedPtr node_;
  rclcpp::Service<botanbot_msgs::srv::GetOctomap>::SharedPtr srv_;
